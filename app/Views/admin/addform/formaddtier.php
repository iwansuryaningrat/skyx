        ...
        <div class="page-inner">
            <div class="page-header">
                ...
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="/add/addtierform">Form Add Tier</a>
                    </li>
                </ul>
            </div>
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <h4 class="card-title">Add Tier Data</h4>
                            </div>
                        </div>
                        <form id="exampleValidation" action="/add/addtier" method="POST" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            <div class="card-body">
                                <div class="form-group form-show-validation row">
                                    ...
                                    <div class="col-lg-4 col-md-9 col-sm-8">
                                        <input type="text" class="form-control" id="level" name="level" placeholder="Masukkan Tier Level" required>
                                    </div>
                                </div>
                                <div class="form-group form-show-validation row">
                                    <label for="pool" class="col-lg-3 col-md-3 col-sm-4 mt-sm-2 text-right">Pool <span class="required-label">*</span></label>
                                    <div class="col-lg-4 col-md-9 col-sm-8">
                                        <input type="text" class="form-control" placeholder="Masukkan Pool" aria-label="pool" aria-describedby="pool-addon" id="pool" name="pool" required>
                                    </div>
                                </div>
                                <div class="form-group form-show-validation row">
                                    <label for="jumlah" class="col-lg-3 col-md-3 col-sm-4 mt-sm-2 text-right">Jumlah Koin <span class="required-label">*</span></label>
                                    <div class="col-lg-4 col-md-9 col-sm-8">
                                        <input class="form-control" id="jumlah" placeholder="Masukkan jumlah koin" aria-label="jumlah" aria-describedby="jumlah-addon" name="jumlah" required>
                                    </div>
                                </div>
                            </div>
