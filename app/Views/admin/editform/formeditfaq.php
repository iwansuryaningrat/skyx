    ...
    <div class="container">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">Form Edit FAQ</h4>
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="/edit/editfaqform/<?= $faq['id']; ?>">Form Edit FAQ</a>
                    </li>
                </ul>
            </div>
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <h4 class="card-title">Edit FAQ Data</h4>
                            </div>
                        </div>
                        <form id="exampleValidation" action="/edit/editfaq/<?= $faq['id']; ?>" method="POST" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            <div class="card-body">
                                <div class="form-group form-show-validation row">
                                    ...
                                    <div class="col-lg-6 col-md-9 col-sm-8">
                                        <input type="text" class="form-control" id="pertanyaan" name="pertanyaan" placeholder="Masukkan pertanyaan" value="<?= $faq['pertanyaan']; ?>" required>
                                    </div>
                                </div>
                                <div class="form-group form-show-validation row">
                                    <label for="jawaban" class="col-lg-3 col-md-3 col-sm-4 mt-sm-2 text-right">Jawaban <span class="required-label">*</span></label>
                                    <div class="col-lg-6 col-md-9 col-sm-8">
                                        <textarea type="text" class="form-control" placeholder="Masukkan jawaban" aria-label="jawaban" aria-describedby="jawaban-addon" id="jawaban" name="jawaban" required value="<?= $faq['jawaban']; ?>"></textarea>
