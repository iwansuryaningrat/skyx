            ...
            <div class="container">
                <div class="page-inner">
                    <div class="page-header">
                        <h4 class="page-title">Data Partnership</h4>
                        <ul class="breadcrumbs">
                            ...
                            <li class="nav-item">
                                <a href="/admin/partnership">Data Partnership</a>
                            </li>
                        </ul>
                    </div>
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex align-items-center">
                                        <h4 class="card-title">Data Partnership</h4>
                                        <a class="d-block ml-auto" href="/add/addpartnerform">
                                            <button class="btn btn-primary btn-round d-flex align-items-center">
                                                <i class="la flaticon-add d-block mr-2"></i>
                                                <span class="d-block">Add Partner</span>
                                            </button>
                                        </a>
                                    </div>
                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-button-action">
                                                                <a href="/edit/editpartnerform/<?= $row['id']; ?>">
