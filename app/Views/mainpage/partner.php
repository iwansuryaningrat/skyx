...
<head>
	...
	<link rel="stylesheet" href="assets/vendor/fontawesome-free-5.15.3-web/css/all.min.css"> <!-- fontawesome free v.5.15 -->
	<link rel="stylesheet" href="assets/vendor/akar-icons-fonts-main/src/css/akar-icons.css"> <!-- akar icon styles -->
	<link rel="stylesheet" href="assets/vendor/uicons-bold-rounded/css/uicons-bold-rounded.css"> <!-- flat icon bold rounded icon styles -->

	<link rel="stylesheet" href="assets/css/styles.css"> <!-- skyx styles -->
...
<body>
	<nav class="navbar navbar-expand-lg navbar-light navbar__skyx position-sticky sticky-top">
		<div class="container-fluid m__nav">
			<a class="navbar-brand" href="home.html">
				<img class="nav__img" src="assets/img/skyx-logo.svg" alt="skyx-logo">
			</a> <!-- end navbar bran -->
			...
			<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
				<div class="navbar-nav ms-auto">
					<a class="nav-link nav__link" aria-current="page" href="home.html">Home</a>
					<a class="nav-link nav__link" href="about.html">About Us</a>
					<a class="nav-link nav__link active" href="project.html">Projects</a>
					<a class="nav-link nav__link" href="contact.html">Contact</a>
					<a class="nav-link nav__link" href="faq.html">FAQ</a>
				</div> <!-- end navbar nav -->
			</div> <!-- end navbar -->
		...
		<div id="navbar-mini" class="navbar__mini">
			<div class="nav__mini">
				...
				<div class="navbarmini__head">
					<img src="assets/img/skyx-logo.svg" alt="...">
					<div id="navmini-close" class="navmini__close"><i class="ai-cross"></i></div>
				</div>

				<!-- main -->
				<a class="navmini__link" href="home.html">Home</a>
				<a class="navmini__link" href="about.html">About Us</a>
				<a class="navmini__link" href="project.html">Projects</a>
				<a class="navmini__link" href="contact.html">Contact</a>
				<a class="navmini__link active" href="faq.html">FAQ</a>
	...
	<script src="assets/js/scripts.js"></script> <!-- skyx scripts -->
</body>
